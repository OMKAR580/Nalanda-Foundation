...
import { testimonials, krishanaTestimonials } from "@/data/testimonials";
...
export function CircularTestimonials() {
  ...
  const list = isKrishana ? krishanaTestimonials : testimonials;
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
        ...
        <div className="relative flex items-center justify-center lg:col-span-5 h-[340px] xs:h-[380px] sm:h-[440px] lg:h-[480px] w-full max-w-[400px] mx-auto overflow-visible select-none">
          <div className="relative flex h-full w-full items-center justify-center">
            ...
            <div className={cn(
              "absolute inset-0 rounded-full blur-3xl opacity-25 dark:opacity-35",
              isKrishana
                ? "bg-[radial-gradient(circle,_#0ea5e9_0%,_transparent_70%)]"
            ...
            >
              {list[prevIndex].image && !imageErrors[prevIndex] ? (
                <div className="relative h-full w-full">
                  ...
                  <div className={cn(
                    ...
                    isKrishana ? "bg-cyan-500/10 dark:bg-cyan-950/30" : "bg-[#800020]/10 dark:bg-[#000]/30"
                  )} />
                </div>
              ) : (
                <div className={`flex h-full w-full items-center justify-center bg-gradient-to-br ${list[prevIndex].color} text-4xl font-bold text-white shadow-inner`}>
                  {list[prevIndex].initials}
                </div>
              )}
            </motion.div>
            ...
            <motion.div
              ...
              className={cn(
                "absolute z-20 flex w-[200px] h-[255px] xs:w-[230px] xs:h-[295px] sm:w-[270px] sm:h-[345px] lg:w-[300px] lg:h-[385px] items-center justify-center rounded-[2rem] border-[3px] bg-gradient-to-br from-[var(--card)] via-[var(--background)] to-[var(--card)] p-1 overflow-hidden",
                isKrishana
                  ? "border-cyan-500 dark:border-emerald-400 shadow-[0_15px_45px_rgba(14,165,233,0.25)] dark:shadow-[0_15px_50px_rgba(16,185,129,0.25)]"
                  : "border-[#800020] dark:border-[#D08E2F] shadow-[0_15px_45px_rgba(128,0,32,0.25)] dark:shadow-[0_15px_50px_rgba(208,142,47,0.25)]"
              )}
            ...
            >
              {activeTestimonial.image && !imageErrors[activeIndex] ? (
                <div className="relative h-full w-full rounded-[1.8rem] overflow-hidden">
                  ...
                  />
                  <div className={cn(
                    "absolute inset-0 rounded-[1.8rem] pointer-events-none",
                    isKrishana ? "ring-1 ring-cyan-500/20 dark:ring-emerald-400/30" : "ring-1 ring-[#800020]/20 dark:ring-[#D08E2F]/30"
                  )} />
                </div>
              ) : (
            ...
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 260, damping: 25 }}
            >
              {list[nextIndex].image && !imageErrors[nextIndex] ? (
                <div className="relative h-full w-full">
                  <Image
                    src={list[nextIndex].image!}
                ...
                <div className={`flex h-full w-full items-center justify-center bg-gradient-to-br ${list[nextIndex].color} text-4xl font-bold text-white shadow-inner`}>
                  {list[nextIndex].initials}
                </div>
              )}
            </motion.div>
          </div>
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          <div className={cn(
            "relative min-h-[300px] rounded-3xl border bg-gradient-to-br from-[var(--card)]/90 via-[var(--card)]/50 to-[var(--background)] p-6 shadow-xl backdrop-blur-md sm:p-8",
            isKrishana
              ? "border-cyan-500/20 dark:border-cyan-400/30 dark:shadow-[0_20px_50px_rgba(14,165,233,0.15)]"
              : "border-[var(--primary)]/20 dark:border-[var(--primary)]/30 dark:shadow-[0_20px_50px_rgba(128,0,32,0.15)]"
          )}>
            ...
            <div className="border-b border-[var(--border)]/20 pb-4 mb-4">
              <h3 className={cn(
                ...
                isKrishana ? "text-slate-950 dark:text-white font-sans" : "text-[#2E1E1E] dark:text-[var(--foreground)] font-serif"
              )}>
            ...
            <div className="overflow-hidden min-h-[100px]">
              <AnimatePresence mode="wait" custom={direction}>
                ...
                >
                  <p className={cn(
                    "text-base italic leading-relaxed sm:text-lg",
                    isKrishana ? "font-sans text-slate-700 dark:text-white" : "font-serif text-[var(--foreground)]"
                  )}>
            ...
            <div className="mt-6 flex items-center justify-between border-t border-[var(--border)]/20 pt-4">
                ...
                {list.map((_, index) => (
                  <button
                    ...
                    className={cn(
                      ...
                      index === activeIndex 
                        ? "w-6 bg-[var(--primary)]" 
                        : "w-2 bg-[var(--primary)]/30 hover:bg-[var(--primary)]/65"
                    )}
              ...
              <div className="flex gap-3">
                <button
                  onClick={handlePrev}
                  className={cn(
                    "flex h-10 w-10 items-center justify-center rounded-full text-white transition-all active:scale-95 shadow-md",
                    isKrishana ? "bg-slate-800 hover:bg-cyan-600" : "bg-[#2E1E1E] hover:bg-[#800020]"
                  )}
