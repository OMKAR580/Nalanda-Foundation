...
const heroCopyBadges: HeroCopyBadge[] = [
  {
    label: "Heritage-Led Career Learning",
    icon: ShieldCheck,
  },
  {
        ...
        >
          ...
          <motion.div variants={revealUp} className="space-y-4">
            ...
            <p className="mx-auto max-w-[37.5rem] text-[15px] leading-[1.6] text-[var(--muted-foreground)] sm:text-base sm:leading-[1.7] lg:mx-0">
              Explore premium certification and internship programs designed to
              help students build practical industry skills, confidence, and
              career-ready portfolios under the Nalanda Foundation legacy.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              Join our WhatsApp community for quick updates
            </a>
          </motion.div>
        </motion.div>
